...
// TODO(b/456480920) Expand to support unified layout con for both standalone Tasks and GroupTasks
// (split-screen pairs).
sealed interface TaskLayoutConfig {
    /**
     * Holds pre-scaled configuration values related to desktop task layout dimensions. These values
     * are typically derived from resources and then scaled according to the current view and screen
     * dimensions.
     *
