...
class ExternalDisplayShortcutFactory
@Inject
constructor(
    ...
    override fun getShortcuts(
    ...
    ): List<SystemShortcut<RecentsViewContainer>>? {
        ...
        return when {
            ...
            desktopModeCompatPolicy.shouldDisableDesktopEntryPoints(
                ...
                listOf(
                    ExternalDisplayShortcut(container, abstractFloatingViewHelper, taskContainer)
                )
            }
        }
    }
    ...
    companion object {
        private class ExternalDisplayShortcut(
            container: RecentsViewContainer,
