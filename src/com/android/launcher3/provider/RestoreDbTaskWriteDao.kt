...
class RestoreDbTaskWriteDao(private val dbController: ModelDbController) : IRestoreDbTaskWriteDao {

    override fun deleteItemsFromUnrestoredProfiles(validProfileIds: Collection<Long>): Int {
        val selection = "${Favorites.PROFILE_ID} NOT IN (${validProfileIds.joinToString()})"
        return dbController.delete(selection, null)
    }
    ...
    override fun bulkUpdateRestoredFlag(flag: Int, itemType: Int?): Int {
        ...
        return dbController.update(values, whereClause, whereArgs)
    }
    ...
    override fun migrateProfileId(oldProfileId: Long, newProfileId: Long): Int {
        ...
        return dbController.update(values, selection, selectionArgs)
    }

    override fun updateDefaultProfileId(newProfileId: Long) {
        @Suppress("DEPRECATION") val db = dbController.db
    ...
    override fun removeScreenIdGaps(
        ...
        @Suppress("DEPRECATION") dbController.db.execSQL(sql)
    }
    ...
    override fun updateAppWidgetId(
        ...
        val rowsUpdated = dbController.update(values, selection, selectionArgs)
